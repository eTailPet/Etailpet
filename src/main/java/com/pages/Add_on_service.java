...
public WebDriver driver;
	...
	By enter_service_name=By.xpath("//input[@placeholder='Enter add-on service name']");
	By enter_service_index=By.xpath("//input[@placeholder='Enter add-on service index value']");
